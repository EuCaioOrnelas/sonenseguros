  ...
  return (
    <>
      ...
      <div className="section">
        <div className="tittleTermos">
          <h2>Termos e Condições de Uso</h2>
        </div>{" "}
        <div className="content">
          <p>Seja bem-vindo ao Click Wiize!</p>
          <p>
            Estes termos e condições descrevem as regras de uso do site da
            empresa Click Wiize, localizado no endereço
            https://www.clickwiize.com.br/.
          </p>
          <p>
            Ao acessar este site, consideramos que você está de acordo com os
            termos e condições abaixo. Não continue a usar o Click Wiize caso
            você discorde dos termos e condições descritos neste contrato.
          </p>
          <br />
          <br />
          <h4>Cookies:</h4>
          <p>
            O site usa cookies para ajudar na personalização da sua experiência
            na internet. Ao acessar o site Click Wiize, você concorda com o uso
            dos cookies requeridos.
          </p>{" "}
          <p>
            ...
            associados exclusivamente a você e só podem ser lidos pelo servidor
            web do domínio que emitiu o cookie.
          </p>
          <br />
          <p>
            Nós podemos usar cookies para coletar, armazenar ou rastrear
            informações para finalidades estatísticas e mercadológicas do nosso
            site. Você tem a opção de aceitar ou rejeitar os cookies opcionais.
            Existem alguns cookies obrigatórios, que são necessários para o
            funcionamento de nosso site. Esses cookies obrigatórios são requerem
            seu consentimento. Por favor, tenha em mente que, ao aceitar os
            cookies obrigatórios, você também estará aceitando cookies de
            terceiros, que podem ser usados por terceiros caso você utilize
            serviços fornecidos por eles em nosso site – por exemplo, uma janela
            de reprodução de vídeo fornecida por empresas terceiras e integrada
            ao nosso site.
          </p>
          <br />
          <br />
          <h4>Licença:</h4>
          <p>
            Exceto em casos em que for indicado o contrário, Click Wiize e seus
            licenciados têm direito à propriedade intelectual de todo o material
            postado no Click Wiize. Todos os direitos à propriedade intelectual
            são reservados.
          </p>
          <p>Você não tem permissão para:</p>
          <ul>
            <li>Copiar ou republicar materiais do Click Wiize</li>
            <li>Vender, alugar ou sublocar materiais do Click Wiize</li>
            <li>Reproduzir, duplicar ou copiar materiais do Click Wiize</li>
            <li>Redistribuir conteúdos do Click Wiize</li>
          </ul>
          <p>Este Acordo terá efeito a partir da data presente.</p>
          <br />
          <p>
            Partes deste site oferecem ao usuário a oportunidade de postar e
            discutir opiniões e informações em determinadas áreas. Click Wiize
            ...
            pessoa que os posta. Na extensão em que as leis aplicáveis permitem,
            Click Wiize não se responsabiliza legalmente pelos Comentários ou
            quaisquer danos, riscos ou despesas causadas ou sofridas como
            resultado do uso, e/ou postagem e/ou aparência dos Comentários deste
            site.
          </p>
          <p>
            Click Wiize reserva para si o direito de remover quaisquer
            Comentários que possam ser considerados inapropriados, ofensivos ou
            quebrem os Termos e Condições deste contrato.
          </p>
          <br />
          <p>Você declara e garante que:</p>
          <ul>
            <li>
              Você tem o direito de postar Comentários em nosso site e fora do
              mesmo e tem todas as licenças e consentimentos para tal;
            </li>
            <li>
          ...
          <p>
            Você por meio deste concede a Click Wiize a licença não-exclusiva de
          ...
          <ul>
            ...
            <li>
              ...
              caridade, que não podem inserir links para nosso Site sem
              aprovação prévia.
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            link compensa a ausência do Click Wiize; e (d) o link será inserido
            em um contexto geral informativo.
          </p>
          <p>
            Essas organizações podem postar links para nossa página inicial
            contanto que o link: (a) não seja, de forma alguma, enganoso; (b)
            não insinue falsamente a existência de uma relação de patrocínio,
            endosso, ou aprovação de produtos e/ou serviços da nossa parte; e
            (c) seja apropriado ao contexto em que está sendo inserido.
          </p>
          <p>
            ...
            deve nos informar de seu interesse enviando um e-mail para Click
            Wiize. Por favor, inclua seu some, o nome da sua organização e suas
            informações de contato, assim como a URL do seu site, uma lista das
            URLs do nosso site que você pretende usar como links, e uma lista
            dos sites nos quais você pretende publicar nossas URLs. Aguarde
            entre 2 e 3 semanas para receber uma resposta.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              dentro do contexto e do formato do conteúdo onde o link está sendo
              inserido.
            </li>
          </ul>
          <br />
          <p>
            ...
            outros elementos visuais da Click Wiize sem um acordo de licença
            para o uso da marca registrada.
          </p>
          <br />
          <br />
          ...
          <p>
            ...
            apareça no seu Site. Você concorda em nos proteger e nos defender
            contra todas as acusações que forem levantadas no seu Site. Nenhum
          ...
          <br />
          <br />
          <h4>emoção de links postados em nosso site:</h4>
          <p>
          ...
          <p>
            Nós não garantimos que as informações continas neste site são
            corretas. Nós não garantimos integralidade ou exatidão do conteúdo.
            Não garantimos que o site se manterá disponível ou que o material do
            site se manterá atualizado.
          </p>
          <br />
          <br />
          ...
          <ul>
            <li>
              limitar ou excluir nossa responsabilidade ou sua responsabilidade
              por mortes ou danos pessoais;
            </li>
            <li>
              limitar ou excluir nossa responsabilidade ou sua responsabilidade
              por fraudes ou deturpações fraudulentas;
            </li>
            <li>
            ...
            <li>
              excluir quaisquer responsabilidades suas ou nossas que não podem
              ser excluídas de acordo com a lei aplicável.
            </li>
            <br />
            <p>
            ...
            <p>
              ...
              oferecidos gratuitamente, nós não seremos responsáveis por perdas
              e danos de qualquer natureza.
            </p>
          </ul>
        </div>
      </div>
