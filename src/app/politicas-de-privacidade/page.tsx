...
// CSS STYLES //
import "./style/politicasdeprivacidade.css";
import "../globals.css";
  ...
  return (
    <>
      ...
      <div className="section">
        <div className="titlePoliticas">
          <h2>Política de privacidade</h2>
        </div>
        <div className="content">
          <p>
            O site https://www.clickwiize.com.br/ é de propriedade da empresa
            Click Wiize, que é a controladora de seus dados pessoais.
          </p>
          <p>
            Nós adotamos esta Política de Privacidade, que determina como nós
            estamos processando as informações coletadas pelo site
            https://www.clickwiize.com.br/ e também explica por quais razões nós
            precisamos coletar dados pessoais sobre você. Portanto, você deve
            ler esta Política de Privacidade antes de usar o site
          ...
          <br />
          <br />
          <h4>Estes são as informações pessoais que coletamos:</h4>
          <p>
            Quando você visita o site https://www.clickwiize.com.br/, nós
            automaticamente coletamos certas informações sobre seu dispositivo,
            incluindo informações sobre seu navegador, endereço IP, fuso horário
            e alguns dos cookies instalados no seu dispositivo. Além disso,
            quando você navega pelo Site, nós coletamos informações sobre as
            páginas individuais ou produtos que você visualiza, sobre quais
            sites ou termos de busca redirecionaram você para nosso Site, e
            sobre como você interage com o Site. Nós nos referimos a essas
            informações coletadas automaticamente como "Informações sobre o
            dispositivo". Além disso, nós podemos coletar dados pessoais que
            você fornecer (incluindo, mas não limitado a: Nome, Sobrenome,
            Endereço, informações de pagamento, etc) durante o processo de
            registro para poder cumprir o acordo.
          </p>
          <br />
          <br />
          <h4>Por que fazemos o processamento dos seus dados?</h4>
          <p>
          ...
          <p>
            ...
            pessoais para nós, como seu e-mail, nome, sobrenome, cidade de
            residência, organização e número de telefone. Você pode escolher não
            fornecer dados pessoais para nós, mas, dessa forma, talvez você não
            ...
            entrarem em contato conosco pelo e-mail clickwiize@gmail.com.
          </p>
          <br />
          <br />
          <h4>Seus direitos:</h4>
          ...
          <ul>
            ...
            <li>
              Direitos em relação a tomadas de decisão automáticas e à
              perfilagem.
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            informações poder ser transferidas para fora da Europa, incluindo
          ...
          <p>
            ...
            você a estar ciente de quando sair do nosso site, e também
            incentivamos você a ler a política de privacidade de cada um dos
          ...
          <p>
            Nós garantimos que as informações que você fornece estão em
            servidores e computadores armazenados em ambientes seguros e
            controlados, protegidos de acessos, usos e divulgações não
            autorizadas. Nós matemos medidas de segurança administrativas,
            técnicas e físicas razoáveis, com finalidade de proteger os dados
            pessoais sob nossa custódia de de acessos, usos, modificações e
            divulgações não autorizadas. Apesar disso, nenhuma transmissão de
            dados pela Internet ou por sistemas sem fio pode ser garantida.
          </p>
          <br />
          <br />
          <h4>Declaração legal:</h4>
          <p>
